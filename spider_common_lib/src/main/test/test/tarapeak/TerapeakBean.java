...
public class TerapeakBean {
	private CommonData average_end_price;
	private CommonData bids;
	private CommonData bids_per_listings;
	private CommonData items_sold;
	private CommonData revenue;
	private CommonData sell_through;
	private CommonData total_listings;
